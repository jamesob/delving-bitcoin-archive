...
conduition | 2026-06-01 17:41:52 UTC | #3
...
(2) What's the logic for using ML-DSA-65 (192 bit security) instead of the smaller 128-bit security level parameter set, ML-DSA-44? In the BIP you hand-wave this choice away with the following statement: > Level 3 is the middle, and the middle is right. ML-DSA-44 has the same classical security level as secp256k1 (128 bits), and is significantly smaller. Why is 192 bits necessary? 
