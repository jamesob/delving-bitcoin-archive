...
jgmcalpine | 2026-02-18 19:55:08 UTC | #1
...
The decision to keep the library \`no_std\` is deliberate. For VTXO-based scaling solutions to reach their full potential, we must provide a path for verification within high-security, restricted environments like hardware wallets. This would allow devices like a hardware wallet to run a lean Rust library to verify the “Map” before a user signs a Forfeit transaction.
